TROLOLO.Views.ListShow = Backbone.CompositeView.extend({
  orderOptions: {
  ...
  addCard: function (card) {
    var view = new TROLOLO.Views.CardShow({
      model: card
    });
  ...
  receiveCard: function(event, ui) {
    ...
    var cardClone = new TROLOLO.Models.Card({
      id: cardId,
  ...
  renderFooter: function () {
    var formView = new TROLOLO.Views.CardForm({
...
_.extend(TROLOLO.Views.ListShow.prototype, TROLOLO.Utils.OrdView);
